"""Generate reproducible Phase-1 MOT data and figures from documented models."""
...
CONFIG_PATH = ROOT / "configs" / "rb87_standard_mot.yaml"
...
def main() -> None:
    ...
    plt.rcParams["svg.hashsalt"] = "cold-atom-mot-phase1"
    ...
    plt.xlabel("x (mm)"); plt.ylabel("$v_x$ (m/s)"); plt.title("Level-A deterministic force map")
    save("force_map_x_vx")
    ...
    fig.suptitle("Phase-1 parameter sensitivities (model calculations, not fitted scalings)")
    ...
    metadata = {
        ...
        "model_fidelity": "Level A effective two-level semiclassical/stochastic",
