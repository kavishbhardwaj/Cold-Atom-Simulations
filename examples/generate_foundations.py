...
from cold_atom_mot.foundations import (  # noqa: E402
    BOLTZMANN,
...
def save_figure(output_dir: Path, name: str) -> None:
    """Save the foundational figure as display PNG and vector SVG."""
...
def main() -> None:
    ...
    output_dir = ROOT / "results" / "foundations"
...
optical dipole trap. They can be regenerated with `python examples/generate_foundations.py`.
